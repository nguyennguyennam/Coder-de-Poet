...
const CourseItem = ({ course }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden group">
      <div className="relative">
        ...
        onError={(e) => {
            // Nếu maxresdefault lỗi → fallback về hqdefault
      ...
      <div className="p-5">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2 text-gray-600">
            ...
            <span className="text-sm">{student_count.toLocaleString()} học viên</span>
          </div>
        </div>
      </div>
    </div>
