    ...
    >
      ...
      <div className="flex flex-col py-6 space-y-6 w-full">
        ...
        <ul className="flex flex-col space-y-1 text-gray-700 font-medium flex-1 gap-[calc(1vh_+_5px)]">
          ...
          <NavItem to={`${user === null ? '/chat' : user.role === "Admin" ? '/admin/member': user.role === "Instructor" ? '/instructor/member':'/chat'}`} label="chat" icon="message-bubble-notification" isOpen={isOpen} />
        </ul>
      </div>
